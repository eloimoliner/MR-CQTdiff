    ...
    def __init__(self, 
        ...
        **kwargs):
        ...
        if progressive != 'output_skip':
            modules.append(nn.GroupNorm(num_groups=min(in_ch // 4, 32),
                                                                    num_channels=in_ch, eps=1e-6))
            modules.append(conv3x3(2, self.total_channels, init_scale=init_scale))
    ...
    def forward(self, x, time_cond=None):
        ...
        for i_level in range(self.num_resolutions):
            ...
            for i_block in range(self.num_res_blocks):
                ...
                #print("i_level", i_level, "i_block", i_block, "h", h.shape)
                m_idx += 1
        ...
        for i_level in reversed(range(self.num_resolutions)):
            ...
            #print("i_level", i_level, "h", h.shape)
...
class NCSNppTime(NCSNpp):
    ...
    def __init__(self, stft=None, **kwargs):
        ...
        **kwargs)
        ...
        self.compression = stft.compression
