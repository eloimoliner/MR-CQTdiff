...
class Trainer():
    ...
    def get_batch(self):
        ...
        return sample[..., :self.args.exp.audio_len]
...
def _main(args):
    ...
    tester = Tester(args, network_tester, diff_params, device=device, in_training=True, inference_test_set=None)

    # Trainer
    trainer = Trainer(args, train_loader, network, diff_params, tester, device)  
